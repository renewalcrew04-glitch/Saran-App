...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // ✅ FIXED: Now passes 'uid' correctly to updateCover
  ...
  Future<void> _pickCoverImage() async {
    try {
      ...
      if (token == null || uid == null) throw Exception("User not authenticated");
      ...
      // ✅ FIX: Pass 'uid' as the second argument
      await _profileUpdateService.updateCover(url, uid);
  ...
  Future<void> _pickAvatarImage() async {
    try {
      ...
      // ✅ FIX: Pass 'uid' as the second argument
      await _profileUpdateService.updateAvatar(url, uid);
